...
import {GET, BaseUrl, DefaultHeaders, ResponseTransform, RestTransferStateService, POST, FullHttpResponse, DisableInterceptor, RESTClient} from '@anglr/rest';
...
export class AccountService extends RESTClient implements AuthenticationServiceOptions<any>
{
     ...
     */
    @GET("myaccount/roles")
    public roles(): Observable<AccountRole[]>
    {
        return null;
    }
